...
PRODUCT_COPY_FILES += \
    device/huawei/prague/nfc/libnfc_brcm_pra_L31.conf:system/etc/libnfc-brcm.conf \
    device/huawei/prague/nfc/libnfc-nci.conf:system/etc/libnfc-nci.conf \
    device/huawei/prague/nfc/libnfc_nxp_pra_L31.conf:system/etc/libnfc-nxp.conf \
    device/huawei/prague/nfc/nfcscc_access.xml:system/etc/nfcscc_access.xml \
    device/huawei/prague/nfc/nfcse_access.xml:system/etc/nfcse_access.xml \
